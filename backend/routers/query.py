    ...
    try:
        ...
        for r in rows:
            ...
            data.append({
                ...
                "removal_fee_usd": round(float(r.removal_fee_usd or 0), 2),
...
def get_monthly_summary(
    ...
    try:
        ...
        totals = {
            ...
            "removal_fee_usd": round(float(total_row.removal_fee_usd or 0), 2),
        ...
        for row in all_rows:
            ...
            results.append({
                ...
                "storage_fee_usd": round(float(row.storage_fee_usd or 0) + float(row.returns_fee_usd or 0) + float(row.inbound_fee_usd or 0) + float(row.removal_fee_usd or 0), 2),
